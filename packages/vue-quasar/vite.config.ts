  ...
  build: {
    ...
    lib: {
      ...
      fileName: (format: string) => {
        ...
        return `jsonforms-vue-quasar.${format}.js`;
      },
    },
    rollupOptions: {
      external: [
      ...
      output: {
        globals: (name: string) => {
          if (name === 'vue') {
            return 'Vue';
          } else if (name.startsWith('quasar')) {
            // check https://quasarjs.com/en/getting-started/installation/#using-cdn
        ...
        assetFileNames: 'jsonforms-vue-quasar.[ext]',
      },
    },
